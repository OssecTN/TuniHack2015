            ...
            <p class="lead">
                These are your credentials.
                     ...
                     <div class="input-group">
                      ...
                      <input type="text" class="form-control" value="<?php echo $_SESSION['name'];?>" aria-describedby="basic-addon1">
                    </div>
                   
                   
                    <div class="input-group">
                      <span class="input-group-addon" id="basic-addon3">Email:</span>
                      <input type="text" class="form-control" value="<?php echo $_SESSION['email'];?>" id="basic-url" aria-describedby="basic-addon3">
                    </div>
